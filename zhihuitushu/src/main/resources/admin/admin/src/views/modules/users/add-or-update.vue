<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="读者名" prop="username">
          <el-input v-model="ruleForm.username" 
              placeholder="读者名" clearable  :readonly="ro.username"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="读者名" prop="username">
              <el-input v-model="ruleForm.username" 
                placeholder="读者名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
